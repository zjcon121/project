...
`ifndef LVC_AHB_MASTER_IF__SV
`define LVC_AHB_MASTER_IF__SV

interface lvc_ahb_master_if (input bit clk, input bit rst);
...
endinterface: lvc_ahb_master_if

`endif // LVC_AHB_MASTER_IF__SV
