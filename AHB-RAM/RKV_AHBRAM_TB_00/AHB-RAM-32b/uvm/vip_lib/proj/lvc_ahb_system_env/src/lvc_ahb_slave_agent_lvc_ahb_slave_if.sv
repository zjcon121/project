...
`ifndef LVC_AHB_SLAVE_IF__SV
`define LVC_AHB_SLAVE_IF__SV

interface lvc_ahb_slave_if (input bit clk, input bit rst);
...
endinterface: lvc_ahb_slave_if

`endif // LVC_AHB_SLAVE_IF__SV
