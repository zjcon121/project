...
`ifndef LVC_AHB_SLAVE_AGENT__SV
`define LVC_AHB_SLAVE_AGENT__SV


class lvc_ahb_slave_agent extends uvm_agent;
   // ToDo: add sub environment properties here
   protected uvm_active_passive_enum is_active = UVM_ACTIVE;
   lvc_ahb_slave_driver slv_drv;
   lvc_ahb_slave_monitor slv_mon;
   lvc_ahb_slave_sequencer slv_seqr;
   typedef virtual lvc_ahb_slave_if vif;
   vif slv_agt_if;

   `uvm_component_utils_begin(lvc_ahb_slave_agent)
   ...
   virtual function void build_phase(uvm_phase phase);
      ...
      slv_mon = lvc_ahb_slave_monitor::type_id::create("mon", this);
      if (is_active == UVM_ACTIVE) begin
         slv_drv = lvc_ahb_slave_driver::type_id::create("drv", this);
         slv_seqr = lvc_ahb_slave_sequencer::type_id::create("slv_seqr",this);
      end
...
endclass: lvc_ahb_slave_agent

`endif // LVC_AHB_SLAVE_AGENT__SV
